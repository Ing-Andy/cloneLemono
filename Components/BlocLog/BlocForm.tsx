...
const BlocForm: React.FC<{Role: string}> = ({Role}) => {
    ...
    <div className='BlocForm'>
        ...
        <form action="" className='Form' method='post'>
            ...
            <p className='pend'>A la place aurais vous souhaiter vous {isForConnect == false ? <span onClick={handleForm}>incrire</span>:<span onClick={handleForm}>connecter</span>} ?</p>
        </form>
    </div>
  )
}
